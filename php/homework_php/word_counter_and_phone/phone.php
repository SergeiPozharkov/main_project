...
<body>
    ...
    if (!empty($_POST["phone"])) {
        ...
        // $pat = "/^([80212]{5}+[\d]{6})|([\+375212]{7}+[\d]{6})|([\+375\(212\)]{9}+[\d]{6})|([\+375\(212\)]{9}+\d{2}\-+\d{2}\-[\d]{2})|([\+375\-\(212\)\-]{11}+\d{2}\-+\d{2}\-[\d]{2})|(\d{6})$/iu";
        $pat = "/^(80212+[\d]{6})$|^(\+375212+[\d]{6})$|^(\+375\(212\)+[\d]{6})$|^(\+375\(212\)+\d{2}\-+\d{2}\-[\d]{2})$|^(\+375\-\(212\)\-+\d{2}\-+\d{2}\-[\d]{2})$|^(\d{6})$/";
